...
@section('content')
    ...
    <div class="container-fluid">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Persembahan Kunjungan HUT Kelahiran dan Pernikahan</h1>
        <!-- Button trigger modal -->
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
          <i class="fas fa-plus fa-sm text-white-50"></i>
          Tambah Data
        </button>
        {{-- <a href="{{ route('persembahan-kunjungan.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Data</a> --}}
      </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="text-center">
                        <a href="{{ route('persembahan-kunjungan.edit', $item->id) }}" class="btn btn-info">
                          <i class="fa fa-pencil-alt"></i>
                        </a>
                        <form action="{{ route('persembahan-kunjungan.destroy', $item->id) }}" method="POST" class="d-inline">
                          @csrf
                          @method('delete')
                  ...
                  <form action="{{ route('persembahan-kunjungan.store') }}" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <select name="keterangan" class="form-control">
                        ...
                        <option value="HUT Pernikahan">HUT Pernikahan</option>
                      </select>
                    </div>
